...
== Contributing
* cd into ```test/dummy``` and run ```RAILS_ENV=test bundle exec rake db:schema:load```
* cd to the top level directory of the gem and run ```bundle exec rake```
* HACK HACK HACK
* When all tests are passing, submit a PR.
* Thanks!!
